...
<script>
  ...
  import DevicePicker from 'sample-web-player/src/components/DevicePicker.svelte';
...
<div class="container">
  ...
  <small class="prompt-label">Limited to single velocity, compressed samples.</small>
