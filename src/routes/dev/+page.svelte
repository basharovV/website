...
<section>
    ...
    <p>
        A desktop music player with metadata tagging, smart playlists, map view,
        stats, and features for artists and musicians to manage their own
        tracks.
    </p>
    <small
        >(Currently building, <a href="https://github.com/basharovV/musicat"
            >pre-release availabe</a
        >)</small
    >
    <small
        ><a href="/blog/building-music-player-tauri-svelte">Devlog 1</a></small
    >
    ...
    <p style="display: block;line-height: 1.5em;">
        Sample libraries are great, but in order to try a product you typically
        need to download and install it. As I was making my own sample library I
        wanted a fully playable interactive demo that works in the browser.
    </p>
    ...
    <div class="player-info">
        ...
        <div>
            <select bind:value={selectedSong}>
                ...
                <option value="vb_improv_2" selected
                    >Fast rundown in C minor
                </option>
            ...
            <button
                on:click={() =>
                    player.playMidiFile(`/midi/${selectedSong}.midi`)}
                >Play it</button
            >
    ...
    <br />
    <p>
        💡 Integrating <span style="color: #00ffb3">REAPER</span> and a smart
        bulb to turn <span style="color: red">red</span> when recording.
    </p>
    ...
    <p>
        More info on the <a
            href="https://forum.cockos.com/showthread.php?t=261061"
            >Cockos forums</a
        >
    </p>
    <br />
    ...
    <div class="products">
        <a href="https://tbxproject.com">
            <div>
                ...
                <small
                    ...
                    online research seamlessly in the browser.[abandoned]</small
                >
            </div>
        </a>
        <a href="https://github.com/basharovV/StumbleUponAwesome">
            <div>
                ...
                <small>
                    A fun StumbleUpon-like extension for those interested in
                    development, tech and science.
                </small>
            </div>
        </a>
    </div>
...
<section>
    ...
    <h4>a showcase of some of my UI mockups & prototypes</h4>

    <ul class="designs">
        <li>
            <p>
                ✏️ I'm a fan of the to-do window layout, where a section of the
                screen is reserved for the to-do list, and other apps can't take
                up this space, like a permanent sidebar. I think the Rectangle
                app achieves this quite well with it's Todo mode. <br />However,
                it's a lot of screen real estate to give up for a simple todo
                list, so I was thinking of ways to maximise the use of this
                space. Since I frequently context switch between tasks during
                work, here's a little concept of an app that shows my JIRA
                tasks, and allows to 'pin' the current task to the top of the
                app, useful for time tracking. Tasks can be re-ordered, and
                simple checklist to-dos can be added as well.
            </p>
            <Images image={["/designs/sidebar.png"]} />
        </li>
        <li>
            <p>
                ♫ A hackable music player concept. In this mockup instead of
                playlists we have
                <i>'playlets'</i> - little musical programs that can be run
                inside the player, encouraging new ways to listen to and
                perceive music. As an example I show a simple Wikipedia playlet,
                which brings up songs together with their Wikipedia article.
                <br/>
                <small
                    >[update]: the Wiki view in <a
                        href="https://github.com/basharovV/musicat">musicat</a
                    > is a working implementation of this idea</small
                >
            </p>
            <Images
                images={[
                    "/designs/musicplayer.png",
                    "/designs/musicplayer_2.png"
                ]}
            />
        </li>
        <li>
            <p>
                🔨 A concept UI for the data science world: a command-based data
                tool that can perform smart transformations on documents using
                natural language commands instead of Excel-like formulas or
                menus.
            </p>
        ...
        <li>
            <p>
                Modos: a concept I started thinking about to re-imagine window
                and workspace management on a desktop environment. I regularly
                switch between different tasks (development, design, writing,
                research, music production, etc), and wanted a way to arrange,
                visualise these 'modes' in my OS, and switch between them at the
                click of a button. I started tinkering with a BetterTouchTool
                preset to imagine what this can look like. I left this on hold
